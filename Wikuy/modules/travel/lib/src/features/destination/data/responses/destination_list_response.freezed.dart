...
mixin _$DestinationListResponse {
 ...
 String get status; String get message; List<DestinationDto>? get data; String? get code; List<String>? get errors;
...
@useResult
$Res call({
 String status, String message, List<DestinationDto>? data, String? code, List<String>? errors
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String status,  String message,  List<DestinationDto>? data,  String? code,  List<String>? errors)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DestinationListResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String status,  String message,  List<DestinationDto>? data,  String? code,  List<String>? errors)  $default,) {final _that = this;
switch (_that) {
case _DestinationListResponse():
return $default(_that.status,_that.message,_that.data,_that.code,_that.errors);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String status,  String message,  List<DestinationDto>? data,  String? code,  List<String>? errors)?  $default,) {final _that = this;
switch (_that) {
case _DestinationListResponse() when $default != null:
return $default(_that.status,_that.message,_that.data,_that.code,_that.errors);case _:
  return null;
...
class _DestinationListResponse implements DestinationListResponse {
  const _DestinationListResponse({required this.status, required this.message, final  List<DestinationDto>? data, this.code, final  List<String>? errors}): _data = data,_errors = errors;
...
@override List<DestinationDto>? get data {
  final value = _data;
