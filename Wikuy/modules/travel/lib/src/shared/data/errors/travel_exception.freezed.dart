...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _TravelNotFound value)?  travelNotFound,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TravelNotFound() when travelNotFound != null:
return travelNotFound(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _TravelNotFound value)  travelNotFound,}){
final _that = this;
switch (_that) {
case _TravelNotFound():
return travelNotFound(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _TravelNotFound value)?  travelNotFound,}){
final _that = this;
switch (_that) {
case _TravelNotFound() when travelNotFound != null:
return travelNotFound(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String? msg,  StackTrace? st)?  travelNotFound,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TravelNotFound() when travelNotFound != null:
return travelNotFound(_that.msg,_that.st);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String? msg,  StackTrace? st)  travelNotFound,}) {final _that = this;
switch (_that) {
case _TravelNotFound():
return travelNotFound(_that.msg,_that.st);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String? msg,  StackTrace? st)?  travelNotFound,}) {final _that = this;
switch (_that) {
case _TravelNotFound() when travelNotFound != null:
return travelNotFound(_that.msg,_that.st);case _:
  return null;
