...
abstract class TravelLocalizations {
  ...
  /// No description provided for @destinationListTitle.
  ///
  /// In en, this message translates to:
  /// **'Destination List'**
  String get destinationListTitle;

  /// No description provided for @destinationListEmptyTitle.
  ///
  /// In en, this message translates to:
  /// **'No Destination Found'**
  String get destinationListEmptyTitle;

  /// No description provided for @destinationListEmptyMessage.
  ///
  /// In en, this message translates to:
  /// **'No destination found at the moment'**
  String get destinationListEmptyMessage;

  /// No description provided for @destinationListErrorTitle.
  ///
  /// In en, this message translates to:
  /// **'Failed to Load Destination List'**
  String get destinationListErrorTitle;
}
