...
mixin _$DestinationDto {
 ...
 int get id; String get name; String get description; String get imageUrl; double get rating; int get reviewCount; bool get isPopular;@UtcDateTimeConverter() DateTime get createdAt;@UtcDateTimeConverter() DateTime get updatedAt;
...
@useResult
$Res call({
 int id, String name, String description, String imageUrl, double rating, int reviewCount, bool isPopular,@UtcDateTimeConverter() DateTime createdAt,@UtcDateTimeConverter() DateTime updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String description,  String imageUrl,  double rating,  int reviewCount,  bool isPopular, @UtcDateTimeConverter()  DateTime createdAt, @UtcDateTimeConverter()  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DestinationDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String description,  String imageUrl,  double rating,  int reviewCount,  bool isPopular, @UtcDateTimeConverter()  DateTime createdAt, @UtcDateTimeConverter()  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _DestinationDto():
return $default(_that.id,_that.name,_that.description,_that.imageUrl,_that.rating,_that.reviewCount,_that.isPopular,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String description,  String imageUrl,  double rating,  int reviewCount,  bool isPopular, @UtcDateTimeConverter()  DateTime createdAt, @UtcDateTimeConverter()  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _DestinationDto() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.imageUrl,_that.rating,_that.reviewCount,_that.isPopular,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _DestinationDto extends DestinationDto {
  const _DestinationDto({required this.id, required this.name, required this.description, required this.imageUrl, required this.rating, required this.reviewCount, required this.isPopular, @UtcDateTimeConverter() required this.createdAt, @UtcDateTimeConverter() required this.updatedAt}): super._();
