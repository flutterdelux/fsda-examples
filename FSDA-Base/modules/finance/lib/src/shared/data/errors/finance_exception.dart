...
sealed class FinanceException with _$FinanceException implements AppException {
  ...
  const factory FinanceException.financeNotFound({String? msg, StackTrace? st}) =
      _FinanceNotFound;
  ...
  @override
  String get message => when(financeNotFound: (msg, _) => msg ?? 'Finance not found', walletNotFound: (msg, _) => msg ?? 'Wallet not found');

  @override
  StackTrace? get stackTrace => st;

  @override
  Failure toFailure() => when(financeNotFound: (_, _) => FinanceFailure.financeNotFound, walletNotFound: (_, _) => FinanceFailure.walletNotFound);
