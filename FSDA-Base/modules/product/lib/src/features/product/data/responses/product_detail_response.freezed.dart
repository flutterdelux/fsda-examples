...
mixin _$ProductDetailResponse {
 ...
 String get status; String get message;@JsonKey(fromJson: _productFromJson) ProductDto? get data; String? get code; List<String>? get errors;
...
@override
String toString() {
  return 'ProductDetailResponse(status: $status, message: $message, data: $data, code: $code, errors: $errors)';
}
...
@useResult
$Res call({
 String status, String message,@JsonKey(fromJson: _productFromJson) ProductDto? data, String? code, List<String>? errors
});


$ProductDtoCopyWith<$Res>? get data;
...
as ProductDto?,code: freezed == code ? _self.code : code // ignore: cast_nullable_to_non_nullable
...
$ProductDtoCopyWith<$Res>? get data {
  ...
  return $ProductDtoCopyWith<$Res>(_self.data!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String status,  String message, @JsonKey(fromJson: _productFromJson)  ProductDto? data,  String? code,  List<String>? errors)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductDetailResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String status,  String message, @JsonKey(fromJson: _productFromJson)  ProductDto? data,  String? code,  List<String>? errors)  $default,) {final _that = this;
switch (_that) {
case _ProductDetailResponse():
return $default(_that.status,_that.message,_that.data,_that.code,_that.errors);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String status,  String message, @JsonKey(fromJson: _productFromJson)  ProductDto? data,  String? code,  List<String>? errors)?  $default,) {final _that = this;
switch (_that) {
case _ProductDetailResponse() when $default != null:
return $default(_that.status,_that.message,_that.data,_that.code,_that.errors);case _:
  return null;
...
class _ProductDetailResponse extends ProductDetailResponse {
  const _ProductDetailResponse({required this.status, required this.message, @JsonKey(fromJson: _productFromJson) this.data, this.code, final  List<String>? errors}): _errors = errors,super._();
  factory _ProductDetailResponse.fromJson(Map<String, dynamic> json) => _$ProductDetailResponseFromJson(json);

@override final  String status;
@override final  String message;
@override@JsonKey(fromJson: _productFromJson) final  ProductDto? data;
...
@override $ProductDtoCopyWith<$Res>? get data;
