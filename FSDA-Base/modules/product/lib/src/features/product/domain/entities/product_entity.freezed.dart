...
mixin _$ProductEntity {
 ...
 int get id; String get name; double get price; String get description; int get stock; String get imageUrl; DateTime get createdAt; DateTime get updatedAt;
...
@override
String toString() {
  return 'ProductEntity(id: $id, name: $name, price: $price, description: $description, stock: $stock, imageUrl: $imageUrl, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int id, String name, double price, String description, int stock, String imageUrl, DateTime createdAt, DateTime updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  double price,  String description,  int stock,  String imageUrl,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  double price,  String description,  int stock,  String imageUrl,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ProductEntity():
return $default(_that.id,_that.name,_that.price,_that.description,_that.stock,_that.imageUrl,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  double price,  String description,  int stock,  String imageUrl,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _ProductEntity() when $default != null:
return $default(_that.id,_that.name,_that.price,_that.description,_that.stock,_that.imageUrl,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _ProductEntity implements ProductEntity {
  const _ProductEntity({required this.id, required this.name, required this.price, required this.description, required this.stock, required this.imageUrl, required this.createdAt, required this.updatedAt});
