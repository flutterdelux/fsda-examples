...
mixin _$PaymentDto {
 ...
 String get id; String get userId; double get amount; String get currency;@PaymentStatusConverter() PaymentStatus get status;@UtcDateTimeConverter() DateTime get createdAt;@UtcDateTimeConverter() DateTime get updatedAt;
...
@override
String toString() {
  return 'PaymentDto(id: $id, userId: $userId, amount: $amount, currency: $currency, status: $status, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String userId, double amount, String currency,@PaymentStatusConverter() PaymentStatus status,@UtcDateTimeConverter() DateTime createdAt,@UtcDateTimeConverter() DateTime updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  double amount,  String currency, @PaymentStatusConverter()  PaymentStatus status, @UtcDateTimeConverter()  DateTime createdAt, @UtcDateTimeConverter()  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaymentDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  double amount,  String currency, @PaymentStatusConverter()  PaymentStatus status, @UtcDateTimeConverter()  DateTime createdAt, @UtcDateTimeConverter()  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _PaymentDto():
return $default(_that.id,_that.userId,_that.amount,_that.currency,_that.status,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  double amount,  String currency, @PaymentStatusConverter()  PaymentStatus status, @UtcDateTimeConverter()  DateTime createdAt, @UtcDateTimeConverter()  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _PaymentDto() when $default != null:
return $default(_that.id,_that.userId,_that.amount,_that.currency,_that.status,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _PaymentDto extends PaymentDto {
  const _PaymentDto({required this.id, required this.userId, required this.amount, required this.currency, @PaymentStatusConverter() required this.status, @UtcDateTimeConverter() required this.createdAt, @UtcDateTimeConverter() required this.updatedAt}): super._();
